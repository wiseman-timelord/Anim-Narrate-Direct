...
def create_interface(
    ...
    with gr.Blocks(title="Gen-Gradio-Voice") as demo:
        with gr.Tab("Narrate"):
            ...
            gr.Textbox(
                value=default_model,  # Display the current model
                label="Current Model",
        ...
        with gr.Tab("Configure"):
            ...
            model_selector = gr.Dropdown(
                ...
                choices=available_models,  # Dynamically populate with available models
                value=default_model
            )
            ...
            update_button.click(
                ...
                inputs=[model_selector, speed_slider, volume_gain_slider, save_format_dropdown],
